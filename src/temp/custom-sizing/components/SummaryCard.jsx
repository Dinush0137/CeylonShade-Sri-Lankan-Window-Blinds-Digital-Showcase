  ...
  return (
    <aside className="w-full md:w-[380px] shrink-0">
      <div className="sticky top-[100px] bg-surface-container-lowest rounded-xl border border-outline-variant p-lg shadow-[0px_10px_30px_rgba(31,59,87,0.05)] flex flex-col gap-md">
        ...
        <button className="w-full text-on-secondary font-label-md text-label-md py-4 rounded-xl transition-colors shadow-sm flex justify-center items-center gap-sm mt-sm" style={{ backgroundColor: 'rgb(145, 114, 60)' }}>
          Send Inquiry
